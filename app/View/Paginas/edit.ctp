    ...
    <div class="col-lg-12">
        <section class="panel">
            <header class="panel-heading">
                Formulario para Editar la Pagina          
            </header>
            <div class="panel-body">
                <div class=" form">
                    ...
                    <div class="form-group ">
                        <label for="data[Pagina][descripcion]" class="control-label col-lg-2">Contenido (*)</label>
                        <div class="col-lg-10">
                            <?php echo $this->Form->text('contenido', array('class' => 'form-control', 'minlength' => 2, 'required')); ?>                                              
                        </div>
                    </div>
