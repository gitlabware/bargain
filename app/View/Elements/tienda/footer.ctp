    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-3 col-xs-12 shopinfo">
                <h4 class="title">BARGAIN-WHOLESALE</h4>
    ...
    <div class="copyrights">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 col-sm-4 col-xs-12 payment-icons"> <a href="#a"> <img src="<?php echo $this->webroot; ?>img/tienda/icons/discover.png" alt="discover"> </a> <a href="#a"> <img src="<?php echo $this->webroot; ?>img/tienda/icons/2co.png" alt="2co"> </a> <a href="#a"> <img src="<?php echo $this->webroot; ?>img/tienda/icons/paypal.png" alt="paypal"> </a> <a href="#a"> <img src="<?php echo $this->webroot; ?>img/tienda/icons/mastercard.png" alt="master card"> </a> <a href="#a"> <img src="<?php echo $this->webroot; ?>img/tienda/icons/visa.png" alt="visa card"> </a> <a href="#a"> <img src="<?php echo $this->webroot; ?>img/tienda/icons/moneybookers.png" alt="moneybookers"> </a> </div>
            </div>
        </div>
    </div>
</footer>