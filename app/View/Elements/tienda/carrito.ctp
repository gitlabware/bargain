...
$datosPedido = $modeloPedido->find('first', array(
    'recursive' => 1,
    'conditions' => array(
...
<?php if (!empty($datosPedido)): ?>
    <li class="dropdown"> <a href="<?php echo $this->Html->url(array('controller' => 'productos', 'action' => 'carrito')); ?>"> <i class="fa fa-shopping-cart fa-fw"></i> <span class="hidden-sm"><?php //echo $cantidadTotal; ?> My Cart </span></a> 
<?php else: ?>
    <li class="dropdown"> <a href="#"> <i class="fa fa-shopping-cart fa-fw"></i> <span class="hidden-sm"><?php //echo $cantidadTotal; ?> My Cart  </span></a> 
    <?php endif; ?>
    <!-- Quick Cart -->
    <div class="dropdown-menu quick-cart" id="carrito">
<?php if (empty($datosPedido)): ?>

        <?php else: ?>
            <div class="qc-row qc-row-heading"> <span class="qc-col-qty">QTY.</span> <span class="qc-col-name"><?php echo $cantidadTotal; ?> items in bag</span> <span class="qc-col-price"></span> </div>
