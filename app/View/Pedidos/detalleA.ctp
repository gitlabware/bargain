    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
           <div class="row invoice-list">                
                ...
                <div class="col-lg-4 col-sm-4">
                    <h4>
                      <b>Factura: </b> <?php echo $datosPedido['Pedido']['factura']; ?><br />
                      <?php
                        $fecha = $datosPedido['Pedido']['created'];
                        $fechaSeparada = explode(" ", $fecha);
                        //debug($fechaSeparada);
                      ?>
                      <b>Fecha: </b> <?php echo $fechaSeparada['0']; ?>
                    </h4>                    
                </div>
            </div>
            <div class="row invoice-list">
                ...
                <div class="col-lg-4 col-sm-4">
                    <h4><b>CLIENTE:</b> <?php echo $datosPedido['User']['nombre']; ?></h4>                    
                </div>
                <div class="col-lg-4 col-sm-4">
                    
                </div>
                <div class="col-lg-4 col-sm-4">
                    <h4><b>PEDIDO: </b> <?php echo $datosPedido['Pedido']['numero']; ?></h4>                    
                </div>
            </div>
