            ...
            <div class="row"> 
              ...
              <div class="short-info-wr col-md-12 col-sm-12 col-xs-12">
                <div class="short-info">
                  <div class="product-attr-text">Available: <span class="available">In Stock</span></div>
                  <div class="product-attr-text">SKU: <span><?php echo $datosProducto['Producto']['sku']; ?></span></div>
                  <div class="product-attr-text">Cat: <span><?php echo $datosProducto['Categoria']['nombre']; ?></span></div>
