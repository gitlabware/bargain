            ...
            <div class="panel-body">
                <div class=" form">
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-lg-10">
                            <?php echo $this->Form->textarea('descripcion', array('class' => 'form-control', 'rows' => 2)); ?>                                              
                        </div>
                    </div>
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-lg-2">
                            <input type="number" class="form-control" id="curl" name="data[Producto][precio]" required step="any" />
                        </div>      
                     ...
                     <div class="form-group ">
                        <label for="categoria" class="control-label col-lg-2"> Cantidad</label>                            
                        <div class="col-lg-3">
                            <?php echo $this->Form->text('cantidad', array('class' => 'form-control', 'minlength' => 2, 'required')); ?>                                
                        </div>                        
                    </div>
