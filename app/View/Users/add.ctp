        ...
        <section class="panel">
            ...
            <div class="panel-body">
                <div class=" form">
                    ...
                    <div class="form-group ">
                        <label for="data[User][password]" class="control-label col-lg-2">Password (*)</label>
                        <div class="col-lg-10">
                            <?php echo $this->Form->password('password', array('class' => 'form-control', 'minlength' => 2, 'required')); ?>                                              
                        </div>
                    </div>
